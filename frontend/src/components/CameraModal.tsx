                ...
                {stage === "streaming" ? (
                  <>
                    <button
                      ...
                      className="flex-1 min-w-[120px] flex items-center justify-center gap-2 py-2.5 bg-violet-600 hover:bg-violet-700 rounded-lg font-semibold text-sm transition-colors"
                    >
